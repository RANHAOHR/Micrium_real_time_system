...
*                                                BSP_Ser_WrBytes()
*
* Description : Writes multiple bytes to a serial port.
*
* Argument(s) : buff     The characters to output.
*
* Return(s)   : none.
*
* Caller(s)   : Application.
...
void  BSP_Ser_WrBytes (CPU_INT08U  *buff, int numBytes)
{
    CPU_BOOLEAN  err;
